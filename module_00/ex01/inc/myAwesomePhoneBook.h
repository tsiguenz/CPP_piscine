...
/*   Updated: 2022/05/16 13:42:19 by tsiguenz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define MSG_ERR_EMPTY "Field can't be empty, add contact fail" 
# define MSG_DETAIL "Select an index for see details : "
# define MSG_HEADER_DETAIL "     index|first name| last name|  nickname"
# define MSG_ERR_BAD_FORMAT_INDEX "Bad index. You must try between 0 and "
